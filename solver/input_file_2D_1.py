...
def inputfile(fluid,reservoir,petro,numerical,BC,IC,well):
    ...
    numerical.tfinal = 100 #final time [days]
    ...
    fluid.BP     = 4800         # bubble point pressure [psi]
    ...
    petro.lamda= 1.2078         #fitting parameter for Corey-Brooks model
    petro.Pe   = 0.4571         #capillary entry pressure [psi]
    ...
    BC.value = [[7000],[100 * 5.615],[7000],[100 * 5.615]]      #value of the boundary condition: psi or ft^3/day
