    ...
    for l in range(0,numerical.N):
        ...
        if (l+1) % numerical.Nx != 1:  #not on left boundary
            ...
            if 'Neumann' in BC.type[0]:
                ...
                To[l, l] = To[l, l] - To[l, l]
                Tw[l, l] = Tw[l, l] - Tw[l, l]

                #Q[l, 0] = Q[l, 0] + 2 * Thalf(l, l, 'x', fluid, reservoir, numerical,P,Pw,Pc,Sw) * (BC.value[1][0] - (fluid.rho / 144.0) * numerical.D[l, 0]) * 6.33E-3  # with gravity
                Q[l, 0] = Q[l, 0] + (To[l, l] * (BC.value[0][0] -(fluid.rho[l,0] / 144.0) * numerical.D[l, 0]) * 6.33E-3
                #Qbo[l, 0] = Qbo[l, 0] + (To[l, l] * (BC.value[0][0] * numerical.dx[l, 0]))
                To[l, l] = 0
                ...
                Qbw[l, 0] = Qbw[l, 0] + (Tw[l, l] * (2 * BC.value[0][0] - P[l, 0]))
                Qbo[l, 0] = Qbo[l, 0] + (To[l, l] * (2 * BC.value[0][0] - P[l, 0]))
        ...
        if (l+1) % numerical.Nx != 0:  #not on right boundary
            ...
            if 'Neumann' in BC.type[1]:
                ...
                #Q[l, 0] = Q[l, 0] + 2 * Thalf(l, l, 'x', fluid, reservoir, numerical,P,Pw,Pc,Sw) * (BC.value[1][0] - (fluid.rho / 144.0) * numerical.D[l, 0]) * 6.33E-3  # with gravity
                Qbw[l, 0] = Qbw[l, 0] + Tw[l, l] * (BC.value[1][0] - (fluid.rho / 144.0) * numerical.D[l, 0]) * 6.33E-3
                Qbo[l, 0] = Qbo[l, 0] + To[l, l] * (BC.value[1][0] - (fluid.rho / 144.0) * numerical.D[l, 0]) * 6.33E-3
                ...
                Qbw[l, 0] = Qbw[l, 0] + (Tw[l, l] * (2 * BC.value[1][0] - P[l, 0]))
                Qbo[l, 0] = Qbo[l, 0] + (To[l, l] * (2 * BC.value[1][0] - P[l, 0]))
        ...
        if int(l / numerical.Nx) > 0:  #not bottom boundary
            ...
            if 'Neumann' in BC.type[2][0]:
                ...
                #Q[l, 0] = Q[l, 0] + 2 * Thalf(l, l, 'y', fluid, reservoir, numerical,P,Pw,Pc,Sw) * (BC.value[2][0] - (fluid.rho / 144.0) * numerical.D[l, 0]) * 6.33E-3  # with gravity
                Qbw[l, 0] = Qbw[l, 0] + Tw[l, l] * (BC.value[2][0] * numerical.dy[l, 0])
                Qbo[l, 0] = Qbo[l, 0] + To[l, l] * (BC.value[2][0] * numerical.dy[l, 0])
                ...
                Qbw[l, 0] = Qbw[l, 0] + (Tw[l, l] * (2 * BC.value[2][0] - P[l, 0]))
                Qbo[l, 0] = Qbo[l, 0] + (To[l, l] * (2 * BC.value[2][0] - P[l, 0]))
        ...
        if int(l / numerical.Nx) < numerical.Ny - 1:  #not top boundary
            ...
            if 'Neumann' in BC.type[3]:
                ...
                #Q[l, 0] = Q[l, 0] + 2 * Thalf(l, l, 'y', fluid, reservoir, numerical,P,Pw,Pc,Sw) * (BC.value[3][0] - (fluid.rho / 144.0) * numerical.D[l, 0]) * 6.33E-3  # with gravity
                Qbw[l, 0] = Qbw[l, 0] + Tw[l, l] * (BC.value[3][0] * numerical.dy[l,0])
                Qbo[l, 0] = Qbo[l, 0] + To[l, l] * (BC.value[3][0] * numerical.dy[l, 0])
                ...
                Qbw[l, 0] = Qbw[l, 0] + (Tw[l, l] * (2 * BC.value[3][0] - P[l,0]))
                Qbo[l, 0] = Qbo[l, 0] + (To[l, l] * (2 * BC.value[3][0] - P[l,0]))
